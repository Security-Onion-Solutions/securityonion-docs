16.04.4.1 Release Notes
=======================

-  | As always, make sure you verify the downloaded ISO image:
   | https://github.com/Security-Onion-Solutions/security-onion/blob/master/Verify_ISO.md

-  When the ISO boots, choose the default option (either
   ``live - boot the Live System`` or
   ``Try SecurityOnion 16.04.4.1 without installing``, depending on
   whether your system is traditional BIOS or newer UEFI).
