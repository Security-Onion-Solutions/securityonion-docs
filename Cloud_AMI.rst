...
Prior to launching the Security Onion AMI you may want to create the interface that will be used to monitor your VPC.  
...
- Launch a new instance from the EC2 Dashboard
...
- Choose the appropriate instance type based on the hardware requirements ansd select ``Configure Instance Details``.  For assistance on determining resource requirements please visit our Hardware Requirmentmest section. 
