...
.. note::
   ...
   Here are some high level system differences between Security Onion 2.2 and the older legacy versions:
...
.. warning::
   ...
   We've started updating this documentation for the new Security Onion 2.2. However, please note that this is a work in progress. Many pages have not been updated yet and thus may have incorrect or missing information.
   
Formats
~~~~~~~

This documentation is published online at https://securityonion.net/docs/2.2.  If you are viewing an offline version of this documentation but have Internet access, you might want to switch to the online version at https://securityonion.net/docs/2.2 to see the latest version.

This documentation is also available in PDF format at https://readthedocs.org/projects/securityonion/downloads/pdf/2.2/.
...
To submit a new page, you can submit a pull request (PR) to the 2.2 branch of the ``securityonion-docs`` repo at https://github.com/Security-Onion-Solutions/securityonion-docs.
