...
One option for additional network visibility would be :ref:`netflow` logs from firewalls, switches, or routers showing what traffic was observed by the network device. Another option would be firewall logs showing what traffic was allowed through the firewall and what traffic was denied. Firewall logs may be in different formats such as :ref:`cef`, :ref:`iptables`, or a combination of the two (as in :ref:`unifi` firewalls). We also have support for :ref:`pfsense` and :ref:`opnsense` firewalls and you can find other firewall integrations in the :ref:`third-party-integrations` section.
