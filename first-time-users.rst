...
If this is your first time using Security Onion, then we highly recommend that you start with our Security Onion ISO image and perform a simple IMPORT installation. This can be done in a minimal VM with only 4GB RAM.
