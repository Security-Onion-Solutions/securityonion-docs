...
You can download our Security Onion ISO image or a standard 64-bit CentOS 7 or Ubuntu 20.04 ISO image. We recommend our Security Onion ISO image for most use cases, but you should review the :ref:`partitioning`, :ref:`release-notes`, and :ref:`download` sections for more information.
...
The :ref:`installation` section has steps for our Security Onion ISO image and for standard CentOS 7 and Ubuntu 20.04 ISO images.
