...
With full packet capture, IDS alerts, Zeek data, and endpoint telemetry, there is a daunting amount of data available at the analyst’s fingertips. Fortunately, Security Onion integrates the following tools to help make sense of this data:
