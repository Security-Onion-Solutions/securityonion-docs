...
In Security Onion 2.1, Logstash transports unparsed logs to :ref:`elasticsearch`. :ref:`elasticsearch` then parses and stores those logs.
...
Since Logstash no longer parses logs in Security Onion 2.1, modifying existing parsers or adding new parsers should be done via :ref:`elasticsearch`.
