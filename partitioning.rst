...
If you use our Security Onion ISO image, it will automatically partition your disk for you. If you instead use Rocky Linux 9 or Ubuntu 22.04, you will most likely need to manually modify their default partition layout.
...
If you install using a standard Rocky Linux 9 or Ubuntu 22.04 ISO, then those installers may try to dedicate a large amount of space to ``/home``. You may need to adjust this to ensure that it is not overly large and wasting valuable disk space.
