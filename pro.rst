...
Starting in Security Onion 2.4.70, licensed users of Security Onion Pro can activate the following features: :ref:`oidc` 3rd-party authentication, :ref:`luks` disk encryption, :ref:`fips` OS compliance, :ref:`stig` OS compliance, and time tracking fo :ref:`cases`. In a future release, we will add guaranteed message delivery as a Pro feature.
