...
Please note that if have Elastic auth enabled and you add a new user directly in Kibana, that user will only have access to Kibana and no other apps. If you want the user to have access to all apps, make sure you add the user as shown in the :ref:`adding-accounts` section.
