...
There are a variety of tools here and they all complement each other very well. For example, here's one potential workflow:
 ...
 - find an interesting alert and pivot from there to :ref:`kibana` or :ref:`hunt` for more information about the connection or the IP addresses involved
 ...
 - use :ref:`cyberchef` to further analyze and decode artifacts
