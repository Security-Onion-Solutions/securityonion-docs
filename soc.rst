...
Depending on the options you chose in the installer, connect to the IP address or hostname of your Security Onion installation and then login using the email address and password that you specified. Once logged in, you can now access analyst tools like :ref:`hunt`, :ref:`kibana`, :ref:`cyberchef`, :ref:`playbook`, :ref:`hive`, and :ref:`attack-navigator`.
