...
-  If you're still having problems with our 64-bit ISO image, try downloading the standard 64-bit ISO image for Rocky Linux 9 or Ubuntu 222.04. If they don't run, then you should double-check your 64-bit compatibility.

.. tip::

  If all else fails but standard 64-bit Rocky Linux 9 or Ubuntu 22.04 installs normally, then you can always install our components on top of them as described on the :ref:`installation` page.
